    ...
    if (kObservers) {
        ...
        if (observer &&
            [observer respondsToSelector:
             @selector(radioButtonSelectedAtIndex:inGroup:button:)]){
                [observer radioButtonSelectedAtIndex:rb.index inGroup:rb.groupId button:rb];
            }
    }
...
- (void)defaultInit {
    ...
    [_button setBackgroundColor:[UIColor whiteColor]]; // test
    [_button setImage:[UIImage imageNamed:@"ic_weixuan"]
             forState:(UIControlStateNormal)];
    [_button setImage:[UIImage imageNamed:@"ic_xuanze"]
