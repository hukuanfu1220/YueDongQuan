...
class KYCircularProgress: UIView {
    ...
    private func setup() {
        ...
        self.progressView.shapeLayer().fillColor = UIColor.redColor().CGColor
        ...
        self.progressView.shapeLayer().strokeColor = UIColor.greenColor().CGColor//self.tintColor.CGColor
    }
